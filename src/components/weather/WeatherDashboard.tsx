  ...
  const fetchWeather = async () => {
    ...
    try {
      ...
      const getUVIndex = (weatherIcon: string, temp: number): number => {
        ...
        if (weatherIcon.includes("09") || weatherIcon.includes("10") || weatherIcon.includes("11")) return 3 // Rain
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-blue-200 max-w-2xl mx-auto">
            Informasi cuaca real-time dan prakiraan untuk Pulau Derawan, Kalimantan Timur
          </p>
          {lastUpdated && (
            <p className="text-sm text-blue-300 mt-2">Terakhir diperbarui: {formatLastUpdated(lastUpdated)}</p>
          )}
        </motion.div>
        ...
        >
          ...
          {error && (
            <div className="mt-4 p-3 bg-red-500/20 border border-red-500/30 rounded-lg max-w-md mx-auto">
              ...
              <p className="text-xs text-red-300 mt-1">Menampilkan data cadangan</p>
            </div>
          )}
        </motion.div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="lg:col-span-2 flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <div className="text-xl text-blue-200 capitalize">{weatherData.description}</div>
                        <div className="text-sm text-blue-300">Terasa seperti {weatherData.feelsLike}°C</div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 lg:col-span-2">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="text-sm text-blue-300">Kelembaban</div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="text-sm text-blue-300">Jarak Pandang</div>
                      ...
                      >
                        <Card className="bg-white/10 backdrop-blur-md border-white/20 text-white hover:bg-white/20 transition-all duration-300">
                          <CardContent className="p-4 text-center">
                            ...
                            <div className="text-sm text-blue-200 mb-2 capitalize">{day.description}</div>
                            <div className="flex justify-between items-center">
                              <span className="font-bold text-lg">{Math.round(day.high)}°</span>
                              <span className="text-blue-300">{Math.round(day.low)}°</span>
                            </div>
