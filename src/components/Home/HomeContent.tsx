...
const HeroContent: React.FC = () => (
  <div className="relative z-10 h-screen flex items-center justify-center px-4">
    <Image
      src="/pulau-derawan.jpg?height=1080&width=1920"
      alt="Pulau Derawan"
      fill
    ...
    <div className="text-center max-w-4xl mx-auto">
      ...
      <p className="text-sm md:text-xl font-bold text-white drop-shadow-[1px_1px_0_black] mb-6 leading-tight animate-fade-in hover:scale-105 transition-transform duration-300">
        <span className="px-4 py-2">
